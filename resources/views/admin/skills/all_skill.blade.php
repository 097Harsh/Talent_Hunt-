                ...
                @endif
                    ...
                    <table class="table table-hover">
                        <tr>
                            ...
                            <td>Action</td>
                            <td>
                                <a href="{{route('AddSkill')}}"><button class="btn btn-primary" style="float:right;">ADD</button></a>
                            </td>
                        </tr>
                        ...
                        <tr data-id="{{$skill->skill_id}}">
                            ...
                            <td colspan="2">
                              <a href="{{route('EditSkill',['id' => $skill->skill_id])}}"><button class="btn btn-primary">Edit</button></a>
                              <button class="deleteRecord btn btn-danger" data-id="{{$skill->skill_id}}" value="{{$skill->skill_id}}">Delete</button>
                            </td>
                        </tr>
                        @endforeach
                    </table>
