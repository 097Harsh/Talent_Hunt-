          ...
          <div class="container-fluid">
            ...
            <div class="row g-4">
              ...
              <div class="col-lg-12">
                    ...
                    <!--begin::Header-->
                    <div class="card-header"><div class="card-title">Update Course Record</div></div>
                    <!--end::Header-->
                    <!--begin::Form-->
                    <form action="{{route('UpdatingSkill',['id' => $skill->skill_id])}}" method="post">
                        @csrf
                        <!--begin::Body-->
                        <div class="card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                              ...
                              <span class="text-danger">@error('skill_name') {{$message}}  @enderror</span>
                            </div>
                        </div>               
                        </div>
                        <!--end::Body-->
